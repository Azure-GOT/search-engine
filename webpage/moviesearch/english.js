//TMDB
function script2Demo(){
const API_KEY = 'api_key=9a85a018f878f3af62f324c75c332248';
const BASE_URL = 'https://api.themoviedb.org/3';
//use the below api url for the most popular movies
//const API_URL = BASE_URL + '/movie/{movie_id}/release_dates&'+API_KEY+'&with_original_language=en&page=4';
const API_URL = BASE_URL + '/discover/movie?&'+API_KEY+'&with_original_language=en&page=4';
